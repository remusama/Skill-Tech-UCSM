...
Ubicación: `components/AvatarDisplay.tsx`
...
## 5. El Sistema de Presencia (Eleonor Context)

Ubicación: `contexts/eleonor-context.tsx`

Toda la visibilidad y comportamiento de Eleonor se rige por una **Máquina de Estados de Presencia**:
...
## 6. Cinematografía y Responsividad
...
## 7. Comunicación Backend-Frontend

El frontend interactúa con el backend mediante dos canales principales:
1.  **Server-Sent Events (SSE):** Para el streaming de texto en el chat (`/api/chat/stream`), permitiendo que Eleonor "escriba" su pensamiento en tiempo real.
2.  **Audio Inyección:** El backend envía audio en base64, el frontend lo decodifica y lo inyecta en el `AudioContext` para su análisis de Lip-Sync.

---

## 8. Guía de Interacción Estética
