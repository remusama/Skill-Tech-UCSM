                    ...
                    {loadingMentorExams ? (
                        ...
                        mentorExams.map((exam: any) => (
                            ...
                            >
                                ...
                                <div className="h-full bg-white/[0.03] backdrop-blur-xl border border-white/10 rounded-[2rem] p-6 relative overflow-hidden transition-all duration-300 hover:border-white/20 hover:bg-white/[0.05] hover:shadow-[0_0_25px_rgba(255,255,255,0.05)]">
                                    ...
                                    <div className="flex items-start justify-between gap-4">
                                        <div>
                                            ...
                                            <div className="flex flex-wrap gap-1.5 mt-3">
                                                {(exam.competencies || []).map((c: string) => (
                                                    <span key={c} className="px-2 py-0.5 bg-white/5 text-gray-300 rounded-full text-xs">{c}</span>
                                                ))}
                                            </div>
                                        ...
                                        {exam.status !== 'completed' && (
                                            <button
                                                ...
                                                className="flex-shrink-0 flex items-center gap-2 px-5 py-2.5 bg-white text-black hover:bg-gray-200 rounded-xl font-bold text-sm shadow-lg transition-all">
                            ...
                            >
                                {currentArea!.exams.map((exam: any, i: number) => (
                                    ...
                                    >
                                        ...
                                        <div className="h-full bg-white/[0.03] backdrop-blur-xl border border-white/10 rounded-[2rem] p-6 relative overflow-hidden transition-all duration-300 hover:border-white/20 hover:bg-white/[0.05] hover:shadow-[0_0_25px_rgba(255,255,255,0.05)]">
                                            <div className={cn("absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity")} />
                                            ...
                                            <div className="space-y-4 mt-auto">
                                                <div className="bg-black/30 rounded-xl p-3 grid grid-cols-2 gap-y-2 gap-x-3 text-[10px]">
                                                    <div>
                                                        <span className="text-gray-500 block mb-0.5 uppercase tracking-wider">Duración</span>
                                                    ...
                                                    <div>
                                                        <span className="text-gray-500 block mb-0.5 uppercase tracking-wider">Items</span>
                                                    ...
                                                    <div className="col-span-2 pt-1 border-t border-white/5 mt-1">
                                                        <div className="flex justify-between mb-1">
                                                            <span className="text-gray-500 uppercase tracking-wider">Complejidad</span>
