...
export function NeoPiRResults({ result, onExit }: { result: any; onExit?: () => void }) {
  ...
  return (
    <div className="relative min-h-screen w-full flex flex-col pt-6 overflow-hidden bg-gradient-to-b from-[#012216] via-[#023320] via-40% to-[#3c5a21] z-[250] custom-scrollbar">
      <BackgroundAnimation />
