  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-[#012216] via-[#3c5a21_65%] to-[#85a02f] p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
            ...
            <div className="text-sm text-center w-full">
              {isRegister ? (
                <p className="text-[#f6f6ed]">
                  ...
                  <button onClick={() => setIsRegister(false)} className="text-[#a3ca02] hover:underline font-bold">
                    Inicia sesión
                  </button>
                </p>
              ) : (
                <p className="text-[#f6f6ed]">
                  ...
                  <button onClick={() => setIsRegister(true)} className="text-[#d0b04d] hover:underline font-bold">
                    Regístrate
                  </button>
                </p>
              )}
        ...
        <p className="text-center text-gray-400 text-[10px] mt-8 uppercase tracking-widest">© 2026 SkillTech. Learning Ecosystem.</p>
      </div>
    </div>
  )
}