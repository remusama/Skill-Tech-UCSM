...
export function Profile() {
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center p-4 md:p-12 bg-transparent relative overflow-hidden">
      {/* Fondos Ambientales */}
      ...
      <div className="w-full max-w-md relative z-10">
        <BlurFade delay={0.1} inView>
          <MagicCard className="p-8 rounded-[3rem] bg-white/[0.02] backdrop-blur-3xl border-white/5 shadow-2xl flex flex-col items-center text-center relative overflow-hidden">
            ...
            <span className="text-[9px] font-black uppercase tracking-[0.2em] text-[#B500D1] bg-[#B500D1]/10 px-3.5 py-1 rounded-full border border-[#B500D1]/20 mb-6">
              CREDENCIAL DIGITAL ACTIVA
            </span>

            {/* Código QR */}
            <div className="relative p-6 bg-white rounded-[2rem] border border-white/10 shadow-2xl mb-6 aspect-square w-56 flex items-center justify-center overflow-hidden">
              {isLoading ? (
            ...
            <h4 className="text-xl font-black text-white italic uppercase tracking-wide">
            ...
            <div className="w-full bg-white/5 border border-white/5 rounded-2xl p-4 mt-6 text-left relative">
              <span className="text-[8px] font-black uppercase text-gray-500 tracking-wider">Identificador NFC</span>
