      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <BlurFade delay={0.1} inView>
          <div className="flex flex-col gap-2 mb-10 pl-16 md:pl-0">
            <MagicTitle variant="sparkles" className="text-3xl md:text-6xl tracking-[0.2em] font-black uppercase text-slate-900 dark:text-white">
              CONFIGURACIÓN
            </MagicTitle>
            <div className="flex items-center gap-3 px-4 py-2 bg-slate-200/60 dark:bg-white/5 border border-slate-300 dark:border-white/10 rounded-full self-start backdrop-blur-xl">
              ...
              <span className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-600 dark:text-white/60">Información de la Cuenta y Seguridad</span>
            </div>
          </div>
        </BlurFade>
